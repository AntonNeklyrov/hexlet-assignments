...
public class ProductsController {
    ...
    @PutMapping("/{id}")
    ProductDTO updateProduct(@PathVariable long id, @RequestBody ProductUpdateDTO updateDTO) {
        Product oprionalProduct = productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Product with id " + id + " not found"));

        Product updatedProduct = updateProduct(updateDTO, oprionalProduct);
    ...
    private Product updateProduct(ProductUpdateDTO updateDTO, Product product) {
